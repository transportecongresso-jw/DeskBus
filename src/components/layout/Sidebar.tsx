...
import {
  ...
  LogOut, Moon, Sun, ClipboardList, Settings, ChevronLeft, ChevronRight, CheckCircle2, Shield, CalendarDays, Star, Receipt, Truck, UserCog, BarChart3, Bell, Anchor, Sparkles, UserCheck
} from 'lucide-react'
